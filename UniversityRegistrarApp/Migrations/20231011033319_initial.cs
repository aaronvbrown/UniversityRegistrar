    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemTags", x => x.CourseTagId);
                    table.ForeignKey(
                        name: "FK_ItemTags_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemTags_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemTags_CourseId",
                table: "ItemTags",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemTags_StudentId",
                table: "ItemTags",
                column: "StudentId");
